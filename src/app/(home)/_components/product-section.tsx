    ...
    >
      ...
      >
        <div className={`${reverse ? "lg:col-start-2" : ""}`}>
          ...
          {description && (
            <p className="font-grotesque mb-10 text-base md:text-xl leading-snug">
              {description}
            </p>
          )}
          ...
          {isPrimary ? (
            ...
            <Link href={buttonHref} className="pixel-btn text-base px-10">
              {buttonText}
            </Link>
          )}
          ...
          {progressData && (
            <div className="mt-8 max-w-md">
              ...
              <p className="font-pixel-readable text-xl mt-3 text-[#030213]">
                &gt;{" "}
                <span className="font-pixel text-[10px]">{displayPercent}</span>{" "}

  ...
  return (
    <div className="relative bg-[#050505] text-[#f4f4f6]">
      ...
      <Slider ref={sliderRef} {...settings}>
        <div>
          <SlideShell>
            <div className="max-w-4xl w-full text-center px-10 md:px-14">
              <h2 className="font-pixel text-xl md:text-3xl lg:text-4xl mb-8 silver-text leading-relaxed">
                Get Into IIMs with IIM-Graduate Mentors
              </h2>
              <p className="font-grotesque text-xl md:text-2xl mb-12 text-[#d8d9de]">
        ...
        <div>
          <SlideShell>
            <div className="max-w-4xl w-full text-center px-10 md:px-14">
              ...
              <p className="font-body text-xl md:text-2xl mb-12 text-[#d8d9de]">
        ...
        <div>
          <SlideShell>
            <div className="max-w-6xl w-full text-center px-10 md:px-14">
              <h2 className="font-pixel text-xl md:text-3xl lg:text-4xl mb-8 silver-text leading-relaxed">

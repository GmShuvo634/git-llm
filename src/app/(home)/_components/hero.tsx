  ...
  return (
    <div className="relative bg-[#030213] text-[#f4f4f6]">
      ...
      <button
        ...
        className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 bg-[#0a0a1a] border-2 border-[#b9bbc2] p-3 hover:bg-[#1a1a2a] transition-colors z-10 cursor-pointer"
      >
        <ChevronLeftIcon className="w-6 h-6 text-[#d8d9de]" />
      </button>
      <button
        onClick={() => sliderRef.current?.slickNext()}
        className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 bg-[#0a0a1a] border-2 border-[#b9bbc2] p-3 hover:bg-[#1a1a2a] transition-colors z-10 cursor-pointer"
      >

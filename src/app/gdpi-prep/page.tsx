    ...
    <main className="min-h-screen bg-[#f4f4f6] text-[#050505] pb-20">
      ...
      <div className="px-6 md:px-12 lg:px-24 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="font-grotesque text-xl md:text-2xl mb-12 text-[#030213] leading-snug">
            The shortlist is not the finish line. CAT can get your name into the
            room. WAT & GDPI decides how you hold that room. GII WAT & GDPI
            prepares aspirants for interviews, group discussions, written
            ability, current affairs, and final conversion.
          </p>
          <div className="flex flex-col items-center gap-6">
            <Linked href="/courses?intent=signup">
              Start with 3 Free Mocks
            </Linked>
            <p className="font-pixel text-sm text-[#5a5d66]">
      ...
      <div className="px-6 md:px-12 lg:px-24 py-20 bg-[#ffffff] mt-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="font-grotesque text-xl md:text-2xl mb-12 text-[#030213] leading-snug">
            Get mentored by IIM Graduates who have successfully navigated the
            exact interview boards.
          </p>
          <Link
            href="/courses?intent=signup"
            className="pixel-btn pixel-btn-primary text-base px-10"
          >

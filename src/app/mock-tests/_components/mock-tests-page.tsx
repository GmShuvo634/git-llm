    ...
    <div className="min-h-screen bg-[#f4f4f6] text-[#050505] pb-20">
      ...
      <div className="px-6 md:px-12 lg:px-24 pt-20 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="font-grotesque text-xl md:text-2xl mb-12 text-[#030213] leading-snug">
            Start with your CAT baseline. Before you choose a course, understand
            where you stand. Take 3 free mocks to diagnose your accuracy, speed,
            section balance, and attempt strategy.
          </p>
      ...
      <div className="px-6 md:px-12 lg:px-24 py-20 bg-[#ffffff]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="font-grotesque text-xl md:text-2xl mb-12 text-[#030213] leading-snug">
            Join thousands of successful IIM aspirants who started with our free
            mock tests
          </p>
          <Link
            href="/courses?intent=signup"
            className="pixel-btn-dark text-base px-10"
          >
            Start with 3 Free Mocks
          </Link>
        </div>
